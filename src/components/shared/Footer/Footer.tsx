             ...
             text-left justify-around text-xs pt-4"
                    ...
                    <div className="flex flex-col-reverse md:flex-row justify-between mb-6 mt-6">
                        ...
                        <div className="flex mb-4 md:mb-0 justify-around">
                            ...
                            <a href="http://www.instagram.com/escoteiroararaquara">
                        ...
                        <a href="/login" className="border-1 border-white p-1 rounded-xl hover:cursor-pointer hover:shadow-xl">Sou Escotrista / Dirigente</a>
