                ...
                <div className="w-full lg:w-1/2 space-y-5">
                    ...
                    <div>
                        <button
                            ...
                            className="text-[#ff654d] asap border flex rounded-full hover:cursor-pointer border-[#ff654d] pl-2 pr-2 pt-1 pb-1 font-semibold text-3xl items-center"
                        >
                            <p className="place-self-center">Quem Somos</p>
                            <svg
                                className="h-6 w-6 place-self-center text-[#ff654d] ml-2"
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="2"
