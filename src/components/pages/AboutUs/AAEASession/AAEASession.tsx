export default function AAEASESSION() {
    return (
        <div className="flex w-full justify-center pt-10 pb-10 px-6">
            <div className="w-full lg:w-1/2 max-w-4xl flex flex-col lg:flex-row gap-10">
                <div className="w-full lg:w-1/2">
                    <h1 className="text-[#FF654D] text-3xl font-bold asap">
                ...
                <div className="w-full lg:w-1/2 bg-red-200">
                    aaaaaa as fotos dos gurizoes aqui aqueles mesmo hmmmm isso ai pse ne
                </div>
            </div>
        </div>
    )
